...
def build_live_research(symbol: str, stock_meta: dict):
    ...
    result = {
        ...
        "financial": {
            ...
            "roce": round_nullable(roce, 2),
            "debtToEquity": round_nullable(debt_to_equity, 2),
            "salesGrowthYoY": round_nullable(revenue_growth, 2),
            "currentRatio": round_nullable(current_ratio, 2),
            "netMargin": round_nullable(net_margin, 2),
            "operatingMargin": round_nullable(operating_margin, 2),
        },
        "forensic": {
